...
def main():
    ...
    # Note: Sunshine can auto-download covers; this script will only add apps (no cover fetching)
    ...
    # Always write a single apps.json (user requested per-app-dir removed)
